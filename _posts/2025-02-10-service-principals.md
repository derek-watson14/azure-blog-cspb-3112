...
**Course Link: [Authenticate your Azure deployment pipeline by using service principals](https://learn.microsoft.com/en-us/training/modules/authenticate-azure-deployment-pipeline-service-principals/)**
